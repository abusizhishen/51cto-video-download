...
class cto(object):
    ...
    def train(self, headers, train_id, path):
        ...
        for course in courses:
            ...
            print('获取课程详情')
            res = obj.get_train_course_info(headers, train_id, train_course_id, page)
    ...
    def get_train_course_info(self, headers, train_id, train_course_id):
        ...
        url = 'http://edu.51cto.com/center/wejob/usr/course-infoajax?train_id=%d&train_course_id=%d&page=1&size=1000'%(train_id, train_course_id )
    ...
    def get_train_courses(self,headers,train_id):
        url = 'http://edu.51cto.com/center/wejob/usr/courseajax?train_id=%d&page=1&size=1000'%(train_id)
...
path = 'd:/videos/trains/Python高级自动化开发工程师微职位/'#%d'%(train_id)
#path = 'd:/深度学习'
